      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
        ...
        <div>
          ...
          <div className="flex gap-2">
            <input type="email" placeholder="Email address" className="bg-stone-900 border border-stone-800 rounded px-3 py-1.5 text-xs text-white focus:outline-none focus:border-primary-400 w-full" />
            <button className="bg-primary-600 hover:bg-primary-700 text-white rounded px-4 py-1.5 text-xs font-semibold uppercase tracking-wider transition">Join</button>
          </div>
        </div>
      </div>
