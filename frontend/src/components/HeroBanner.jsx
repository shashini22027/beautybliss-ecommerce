...
const HeroBanner = () => {
  return (
    <div className="relative rounded-2xl overflow-hidden luxury-gradient border border-pink-100 py-20 px-8 sm:px-16 flex flex-col md:flex-row items-center justify-between gap-8 transition-transform hover:scale-[1.005] duration-300">
      ...
      <div className="w-full md:w-1/2 flex justify-center">
        <img src="https://images.unsplash.com/photo-1620916566398-39f1143ab7be?w=600&q=80" alt="Cosmetics Banner" className="max-h-96 object-contain rounded-lg shadow-md hover:rotate-1 transition-transform duration-500" />
      </div>
    </div>
  );
};
